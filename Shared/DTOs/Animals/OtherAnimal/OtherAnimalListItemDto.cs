...
public class OtherAnimalListItemDto : IListingStats
{
    ...
    public OtherAnimalVaccination? Vaccination { get; set; }
    ...
    public List<OtherAnimalImageDto> Images { get; set; } = new();

    public DateTime CreatedAt { get; set; }

    [JsonIgnore]
    public ListingModuleType StatsListingType => ListingModuleType.OtherAnimal;

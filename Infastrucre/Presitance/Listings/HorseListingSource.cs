...
public sealed class HorseListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public HorseListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.Horse;

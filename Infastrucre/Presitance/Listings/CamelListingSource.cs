...
public sealed class CamelListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public CamelListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.Camel;

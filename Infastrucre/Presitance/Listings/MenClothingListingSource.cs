...
public sealed class MenClothingListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public MenClothingListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.MenClothing;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.MenClothings
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.MenClothing,
                Title = x.Title,

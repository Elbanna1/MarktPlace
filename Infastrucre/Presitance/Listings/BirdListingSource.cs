...
public sealed class BirdListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public BirdListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.Bird;

...
public sealed class LightingDecorListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public LightingDecorListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.LightingDecor;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.LightingDecors
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.LightingDecor,
                Title = x.Title,

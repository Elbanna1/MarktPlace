...
public sealed class FurnishingCurtainListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public FurnishingCurtainListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.FurnishingCurtain;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.FurnishingCurtains
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.FurnishingCurtain,
                Title = x.Title,

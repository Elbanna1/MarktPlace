...
public sealed class KidsClothingListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public KidsClothingListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.KidsClothing;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.KidsClothings
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.KidsClothing,
                Title = x.Title,

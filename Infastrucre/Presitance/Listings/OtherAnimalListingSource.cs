...
public sealed class OtherAnimalListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public OtherAnimalListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.OtherAnimal;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.OtherAnimals
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.OtherAnimal,
                Title = x.Title,

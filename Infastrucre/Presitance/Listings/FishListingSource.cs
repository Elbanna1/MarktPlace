...
public sealed class FishListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public FishListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.Fish;

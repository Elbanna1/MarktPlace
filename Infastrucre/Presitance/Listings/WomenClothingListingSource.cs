...
public sealed class WomenClothingListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public WomenClothingListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.WomenClothing;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.WomenClothings
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.WomenClothing,
                Title = x.Title,

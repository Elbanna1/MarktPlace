...
public sealed class SheepGoatListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public SheepGoatListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.SheepGoat;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.SheepGoats
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.SheepGoat,
                Title = x.Title,

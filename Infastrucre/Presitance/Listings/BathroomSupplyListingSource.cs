...
public sealed class BathroomSupplyListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public BathroomSupplyListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.BathroomSupply;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.BathroomSupplies
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.BathroomSupply,
                Title = x.Title,

...
public sealed class KitchenToolListingSource : IUserListingSource
{
    private readonly AppDbContext _context;

    public KitchenToolListingSource(AppDbContext context)
    {
        _context = context;
    }

    public ListingModuleType Type => ListingModuleType.KitchenTool;
    ...
    public IQueryable<UserListingRow> Query(string? ownerId, DateTime utcNow, bool includeUnmoderated = false) =>
        _context.KitchenTools
            ...
            .Select(x => new UserListingRow
            {
                ...
                CategoryId = null,
                SubCategoryId = null,
                Type = ListingModuleType.KitchenTool,
                Title = x.Title,

...
[ApiController]
[Route(HomeFurnishingRoutes.LightingDecor)]
[Authorize]
[Produces("application/json")]
public class LightingDecorController : ControllerBase
{
    private readonly ILightingDecorService _service;

    public LightingDecorController(ILightingDecorService service)
    {
        _service = service;
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<LightingDecorDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<LightingDecorDetailsDto>>> Create(
        [FromForm] CreateLightingDecorRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<LightingDecorDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<LightingDecorListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<LightingDecorListItemDto>>>> GetList(
        [FromQuery] LightingDecorFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<LightingDecorListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<LightingDecorDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LightingDecorDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, countView: true, HttpContext.RequestAborted);
        return Ok(ApiResponse<LightingDecorDetailsDto>.Ok(
    ...
    [ProducesResponseType(typeof(ApiResponse<LightingDecorDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LightingDecorDetailsDto>>> Update(
        Guid id, [FromForm] UpdateLightingDecorRequest request)
    {
        var cancellationToken = HttpContext.RequestAborted;
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LightingDecorDetailsDto>>> ReorderImages(
        Guid id, [FromBody] ReorderHomeFurnishingImagesRequest request)
    {
        ...
        return Ok(ApiResponse<LightingDecorDetailsDto>.Ok(result, UserMessages.Listings.ImagesReordered));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LightingDecorDetailsDto>>> SetPromotion(
        Guid id, [FromBody] PromoteHomeFurnishingRequest request)
    {
        ...
        return Ok(ApiResponse<LightingDecorDetailsDto>.Ok(result, UserMessages.Listings.PromotionUpdated));
    }

    [HttpGet("{id:guid}/similar")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<LightingDecorListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<LightingDecorListItemDto>>>> GetSimilar(
        Guid id, [FromQuery] int count = 8)
    {
        var result = await _service.GetSimilarAsync(id, count, HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<LightingDecorListItemDto>>.Ok(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<LightingDecorListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<LightingDecorListItemDto>>>> GetRelated(
        Guid id, [FromQuery] int count = 8)
    {
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<LightingDecorListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<LightingDecorListItemDto>>>> GetRecentlyAdded(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>>> GetLightTypes()
    {
        var result = await _service.GetLightTypesAsync(HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>.Ok(
            result, UserMessages.Lookups.Loaded));
    }
}

...
public class PaintingsController : ControllerBase
{
    ...
    public PaintingsController(IPaintingService service)
    {
        _service = service;
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<PaintingDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<PaintingDetailsDto>>> Create(
        [FromForm] CreatePaintingRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<PaintingDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<PaintingListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<PaintingListItemDto>>>> GetList(
        [FromQuery] PaintingFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<PaintingListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaintingDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PaintingDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaintingDetailsDto>.Ok(result, UserMessages.Listings.DetailsLoaded));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<PaintingDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PaintingDetailsDto>>> Update(
        Guid id, [FromForm] UpdatePaintingRequest request)
    {
        var cancellationToken = HttpContext.RequestAborted;
        ...
        return Ok(ApiResponse<PaintingDetailsDto>.Ok(result, UserMessages.Listings.Updated));
    }

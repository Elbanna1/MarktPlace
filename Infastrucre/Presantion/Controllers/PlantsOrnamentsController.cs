...
[ApiController]
[Route(HomeFurnishingRoutes.PlantsOrnaments)]
[Authorize]
[Produces("application/json")]
public class PlantsOrnamentsController : ControllerBase
{
    private readonly IPlantOrnamentService _service;

    public PlantsOrnamentsController(IPlantOrnamentService service)
    {
        _service = service;
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<PlantOrnamentDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<PlantOrnamentDetailsDto>>> Create(
        [FromForm] CreatePlantOrnamentRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<PlantOrnamentDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<PlantOrnamentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<PlantOrnamentListItemDto>>>> GetList(
        [FromQuery] PlantOrnamentFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<PlantOrnamentListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PlantOrnamentDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PlantOrnamentDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, countView: true, HttpContext.RequestAborted);
        return Ok(ApiResponse<PlantOrnamentDetailsDto>.Ok(
    ...
    [ProducesResponseType(typeof(ApiResponse<PlantOrnamentDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PlantOrnamentDetailsDto>>> Update(
        Guid id, [FromForm] UpdatePlantOrnamentRequest request)
    {
        var cancellationToken = HttpContext.RequestAborted;
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PlantOrnamentDetailsDto>>> ReorderImages(
        Guid id, [FromBody] ReorderHomeFurnishingImagesRequest request)
    {
        ...
        return Ok(ApiResponse<PlantOrnamentDetailsDto>.Ok(result, UserMessages.Listings.ImagesReordered));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<PlantOrnamentDetailsDto>>> SetPromotion(
        Guid id, [FromBody] PromoteHomeFurnishingRequest request)
    {
        ...
        return Ok(ApiResponse<PlantOrnamentDetailsDto>.Ok(result, UserMessages.Listings.PromotionUpdated));
    }

    [HttpGet("{id:guid}/similar")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>>> GetSimilar(
        Guid id, [FromQuery] int count = 8)
    {
        var result = await _service.GetSimilarAsync(id, count, HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>.Ok(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>>> GetRelated(
        Guid id, [FromQuery] int count = 8)
    {
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<PlantOrnamentListItemDto>>>> GetRecentlyAdded(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>>> GetSuitableFors()
    {
        var result = await _service.GetSuitableForsAsync(HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<HomeFurnishingLookupItemDto>>.Ok(
            result, UserMessages.Lookups.Loaded));
    }
}

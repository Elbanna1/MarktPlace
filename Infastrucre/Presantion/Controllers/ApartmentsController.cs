...
[ApiController]
[Route(RealEstateRoutes.Apartments)]
[Authorize]
...
public class ApartmentsController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ApiResponse<ApartmentDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<ApartmentDetailsDto>>> Create(
        [FromForm] CreateApartmentRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<ApartmentDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<ApartmentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<ApartmentListItemDto>>>> GetList(
        [FromQuery] ApartmentFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<ApartmentListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<ApartmentDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<ApartmentDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, countView: true, HttpContext.RequestAborted);
        return Ok(ApiResponse<ApartmentDetailsDto>.Ok(result, UserMessages.Listings.DetailsLoaded));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<ApartmentDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<ApartmentDetailsDto>>> Update(
        Guid id, [FromForm] UpdateApartmentRequest request)
    {
        var cancellationToken = HttpContext.RequestAborted;
        ...
        return Ok(ApiResponse<ApartmentDetailsDto>.Ok(result, UserMessages.Listings.Updated));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<ApartmentDetailsDto>>> ReorderImages(
        Guid id, [FromBody] ReorderRealEstateImagesRequest request)
    {
        ...
        return Ok(ApiResponse<ApartmentDetailsDto>.Ok(result, UserMessages.Listings.ImagesReordered));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<ApartmentDetailsDto>>> SetPromotion(
        Guid id, [FromBody] PromoteRealEstateRequest request)
    {
        ...
        return Ok(ApiResponse<ApartmentDetailsDto>.Ok(result, UserMessages.Listings.PromotionUpdated));
    }

    [HttpGet("{id:guid}/similar")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<ApartmentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<ApartmentListItemDto>>>> GetSimilar(
        Guid id, [FromQuery] int count = 8)
    {
        var result = await _service.GetSimilarAsync(id, count, HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<ApartmentListItemDto>>.Ok(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<ApartmentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<ApartmentListItemDto>>>> GetRelated(
        Guid id, [FromQuery] int count = 8)
    {
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<ApartmentListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<ApartmentListItemDto>>>> GetRecentlyAdded(
    ...
    [HttpGet(RealEstateLookupKeys.ApartmentTypes)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetApartmentTypes() =>
        Lookup(RealEstateLookupKeys.ApartmentTypes);

    [HttpGet(RealEstateLookupKeys.OwnershipTypes)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetOwnershipTypes() =>
        Lookup(RealEstateLookupKeys.OwnershipTypes);

    [HttpGet(RealEstateLookupKeys.ReceptionPieces)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetReceptionPieces() =>
        Lookup(RealEstateLookupKeys.ReceptionPieces);
    ...
    [HttpGet(RealEstateLookupKeys.FurnishedStatuses)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetFurnishedStatuses() =>
        Lookup(RealEstateLookupKeys.FurnishedStatuses);
    ...
    [HttpGet(RealEstateLookupKeys.ViewTypes)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetViewTypes() =>
        Lookup(RealEstateLookupKeys.ViewTypes);
    ...
    [HttpGet(RealEstateLookupKeys.Features)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetFeatures() =>
        Lookup(RealEstateLookupKeys.Features);
    ...
    [HttpGet(RealEstateLookupKeys.SuitableFor)]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>), StatusCodes.Status200OK)]
    public Task<ActionResult<ApiResponse<IReadOnlyList<RealEstateLookupItemDto>>>> GetSuitableFor() =>
        Lookup(RealEstateLookupKeys.SuitableFor);

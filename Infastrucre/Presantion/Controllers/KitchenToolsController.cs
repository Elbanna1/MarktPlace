...
[ApiController]
[Route(HomeFurnishingRoutes.KitchenTools)]
[Authorize]
[Produces("application/json")]
public class KitchenToolsController : ControllerBase
{
    private readonly IKitchenToolService _service;

    public KitchenToolsController(IKitchenToolService service)
    {
        _service = service;
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<KitchenToolDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<KitchenToolDetailsDto>>> Create(
        [FromForm] CreateKitchenToolRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<KitchenToolDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<KitchenToolListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<KitchenToolListItemDto>>>> GetList(
        [FromQuery] KitchenToolFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<KitchenToolListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<KitchenToolDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<KitchenToolDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, countView: true, HttpContext.RequestAborted);
        return Ok(ApiResponse<KitchenToolDetailsDto>.Ok(
    ...
    [ProducesResponseType(typeof(ApiResponse<KitchenToolDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<KitchenToolDetailsDto>>> Update(
        Guid id, [FromForm] UpdateKitchenToolRequest request)
    {
        var cancellationToken = HttpContext.RequestAborted;
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<KitchenToolDetailsDto>>> ReorderImages(
        Guid id, [FromBody] ReorderHomeFurnishingImagesRequest request)
    {
        ...
        return Ok(ApiResponse<KitchenToolDetailsDto>.Ok(result, UserMessages.Listings.ImagesReordered));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<KitchenToolDetailsDto>>> SetPromotion(
        Guid id, [FromBody] PromoteHomeFurnishingRequest request)
    {
        ...
        return Ok(ApiResponse<KitchenToolDetailsDto>.Ok(result, UserMessages.Listings.PromotionUpdated));
    }

    [HttpGet("{id:guid}/similar")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<KitchenToolListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<KitchenToolListItemDto>>>> GetSimilar(
        Guid id, [FromQuery] int count = 8)
    {
        var result = await _service.GetSimilarAsync(id, count, HttpContext.RequestAborted);
        return Ok(ApiResponse<IReadOnlyList<KitchenToolListItemDto>>.Ok(
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<KitchenToolListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<KitchenToolListItemDto>>>> GetRelated(
        Guid id, [FromQuery] int count = 8)
    {
    ...
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<IReadOnlyList<KitchenToolListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<KitchenToolListItemDto>>>> GetRecentlyAdded(

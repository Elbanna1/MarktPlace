...
public class LivestockController : ControllerBase
{
    ...
    public LivestockController(ILivestockService service)
    {
        _service = service;
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<LivestockDetailsDto>), StatusCodes.Status201Created)]
    public async Task<ActionResult<ApiResponse<LivestockDetailsDto>>> Create(
        [FromForm] CreateLivestockRequest request)
    {
        ...
        return StatusCode(StatusCodes.Status201Created,
            ApiResponse<LivestockDetailsDto>.Ok(result, UserMessages.Listings.Created));
    }

    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<PaginatedResult<LivestockListItemDto>>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PaginatedResult<LivestockListItemDto>>>> GetList(
        [FromQuery] LivestockFilterParams filter)
    {
        var result = await _service.GetListAsync(filter, HttpContext.RequestAborted);
        return Ok(ApiResponse<PaginatedResult<LivestockListItemDto>>.Ok(
            result, UserMessages.Listings.Loaded));
    }

    [HttpGet("{id:guid}")]
    [AllowAnonymous]
    [ProducesResponseType(typeof(ApiResponse<LivestockDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LivestockDetailsDto>>> GetById(Guid id)
    {
        var result = await _service.GetByIdAsync(id, HttpContext.RequestAborted);
        return Ok(ApiResponse<LivestockDetailsDto>.Ok(result, UserMessages.Listings.DetailsLoaded));
    }
    ...
    [ProducesResponseType(typeof(ApiResponse<LivestockDetailsDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ApiResponse<LivestockDetailsDto>>> Update(
        Guid id, [FromForm] UpdateLivestockRequest request)
    {
        ...
        return Ok(ApiResponse<LivestockDetailsDto>.Ok(result, UserMessages.Listings.Updated));
    }

...
public class BathroomSupply : IModeratedListing, IExpiringListing
{
    ...
    public ICollection<BathroomSupplyImage> Images { get; set; } = new List<BathroomSupplyImage>();

    public ICollection<BathroomSupplyColorSelection> Colors { get; set; } =
        new List<BathroomSupplyColorSelection>();
...
public class BathroomSupplyImage : IOrderedListingImage
{
    public Guid Id { get; set; }

    public Guid BathroomSupplyId { get; set; }
    public BathroomSupply BathroomSupply { get; set; } = default!;
...
public class BathroomSupplyColorSelection
{
    public Guid BathroomSupplyId { get; set; }
    public BathroomSupply BathroomSupply { get; set; } = default!;

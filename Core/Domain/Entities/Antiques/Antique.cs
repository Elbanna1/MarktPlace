...
public class Antique : IModeratedListing, IExpiringListing
{
    ...
    public ICollection<AntiqueImage> Images { get; set; } = new List<AntiqueImage>();

    public AntiqueVideo? Video { get; set; }

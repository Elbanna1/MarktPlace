...
public class HomeKitchen : IModeratedListing, IExpiringListing
{
    ...
    public ICollection<HomeKitchenImage> Images { get; set; } = new List<HomeKitchenImage>();

    public ICollection<HomeKitchenColorSelection> Colors { get; set; } = new List<HomeKitchenColorSelection>();
...
public class HomeKitchenImage : IListingImage
{
    public Guid Id { get; set; }

    public Guid HomeKitchenId { get; set; }
    public HomeKitchen HomeKitchen { get; set; } = default!;
...
public class HomeKitchenColorSelection
{
    public Guid HomeKitchenId { get; set; }
    public HomeKitchen HomeKitchen { get; set; } = default!;

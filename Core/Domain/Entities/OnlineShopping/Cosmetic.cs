...
public class Cosmetic : IModeratedListing, IExpiringListing
{
    ...
    public ICollection<CosmeticImage> Images { get; set; } = new List<CosmeticImage>();
...
public class CosmeticImage : IListingImage
{
    public Guid Id { get; set; }

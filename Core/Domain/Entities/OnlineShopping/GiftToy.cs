...
public class GiftToy : IModeratedListing, IExpiringListing
{
    ...
    public ICollection<GiftToyImage> Images { get; set; } = new List<GiftToyImage>();
...
public class GiftToyImage : IListingImage
{
    public Guid Id { get; set; }

    public Guid GiftToyId { get; set; }
    public GiftToy GiftToy { get; set; } = default!;

...
public class UpdateFruitVegetableMerchantRequestValidator
    : AbstractValidator<UpdateFruitVegetableMerchantRequest>
{
    public UpdateFruitVegetableMerchantRequestValidator()
    {

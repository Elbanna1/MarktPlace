...
public class CreateJobRequestRequestValidator : AbstractValidator<CreateJobRequestRequest>
{
    public CreateJobRequestRequestValidator()
    {
    ...
    internal static bool HasAllowedExtension(string? fileName, IReadOnlyCollection<string> allowed)
    {

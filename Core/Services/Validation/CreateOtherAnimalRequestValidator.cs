...
public class CreateOtherAnimalRequestValidator : AbstractValidator<CreateOtherAnimalRequest>
{
    public CreateOtherAnimalRequestValidator()
    {
        ...
        RuleFor(x => x.OtherType)
            ...
            .MaximumLength(150)
            .When(x => x.AnimalType == OtherAnimalType.Other);

...
public class CreateLivestockRequestValidator : AbstractValidator<CreateLivestockRequest>
{
    public CreateLivestockRequestValidator()
    {
        ...
        RuleFor(x => x.OtherBreed)
            ...
            .MaximumLength(150)
            .When(x => x.Breed == LivestockBreed.Other);

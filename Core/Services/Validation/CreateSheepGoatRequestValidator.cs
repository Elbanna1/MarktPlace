...
public class CreateSheepGoatRequestValidator : AbstractValidator<CreateSheepGoatRequest>
{
    public CreateSheepGoatRequestValidator()
    {
        ...
        RuleFor(x => x.OtherBreed)
            ...
            .MaximumLength(150)
            .When(x => x.Breed == SheepGoatBreed.Other);

...
public class CreateWomenClothingRequestValidator : AbstractValidator<CreateWomenClothingRequest>
{
    public CreateWomenClothingRequestValidator()
    {
        ...
        RuleFor(x => x.OtherClothingType)
            ...
            .MaximumLength(150)
            .When(x => x.ClothingType == WomenClothingType.Other);
        ...
        RuleFor(x => x.OtherBrand)
            ...
            .MaximumLength(150)
            .When(x => x.Brand == WomenClothingBrand.Other);

        RuleFor(x => x.Sizes)
            .NotEmpty().WithMessage("لازم تختار مقاس واحد على الأقل.")
            .Must(sizes => sizes.All(size => Enum.IsDefined(typeof(WomenClothingSize), size)))
            .WithMessage("فيه مقاس أو أكتر من اللي اخترتهم مش صحيح.");

        RuleFor(x => x.Colors)
            .NotEmpty().WithMessage("لازم تختار لون واحد على الأقل.")
            .Must(colors => colors.All(color => Enum.IsDefined(typeof(WomenClothingColor), color)))
        ...
        RuleFor(x => x.OtherColor)
            ...
            .MaximumLength(150)
            .When(x => x.Colors.Contains(WomenClothingColor.Other));
...
public class UpdateWomenClothingRequestValidator : AbstractValidator<UpdateWomenClothingRequest>
{
    public UpdateWomenClothingRequestValidator()
    {
        ClothingValidationRules.StoreName(this, x => x.StoreName);
